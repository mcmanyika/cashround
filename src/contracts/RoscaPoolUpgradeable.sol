...
contract RoscaPoolUpgradeable is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    // Basic config - now upgradeable
    ...
    function emergencyPause() external onlyOwner {
        // This would require additional pause logic
        // For now, just an example of admin function
    }
